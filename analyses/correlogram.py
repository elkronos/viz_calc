...
def correlogram(data: pd.DataFrame, method: str = 'pearson', color: str = 'coolwarm', annotate: bool = False, significance: bool = False, p_threshold: float = 0.05, figsize: tuple = (10, 8), title: str = "Correlation Heatmap") -> None:
    """
    ...
    sns.heatmap(corr, annot=annotations, cmap=color, fmt='', vmin=-1, vmax=1).set_title(title)
...
correlogram(df, method='spearman', annotate=True, significance=True)
